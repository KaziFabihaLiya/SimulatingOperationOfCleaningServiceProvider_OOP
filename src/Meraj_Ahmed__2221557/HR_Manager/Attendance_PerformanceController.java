...
public class Attendance_PerformanceController implements Initializable {
    ...
    @FXML
    private void pieChartButtonOnClicked(ActionEvent event) throws IOException {  
        FXMLLoader loader = new FXMLLoader(getClass().getResource("performancePieChart.fxml")); 
